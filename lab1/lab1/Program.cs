...
class Program
{
    static void Main()
    {
        ...
        using (StreamReader reader = new StreamReader("C:\\Users\\Nazar\\source\\repos\\lab1\\INPUT.txt"))
        {
        ...
        using (StreamWriter writer = new StreamWriter("C:\\Users\\Nazar\\source\\repos\\lab1\\OUTPUT.txt"))
        {
