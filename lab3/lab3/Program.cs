...
class Program
{
    static void Main()
    {
        ...
        string[] inputLines = File.ReadAllLines("C:\\Users\\Nazar\\source\\repos\\lab3\\INPUT.TXT");
        ...
        if (FindPath(grid, startX, startY, endX, endY))
        {
            ...
            File.WriteAllText("C:\\Users\\Nazar\\source\\repos\\lab3\\OUTPUT.TXT", "Y\n");
            for (int i = 0; i < N; i++)
            {
                File.AppendAllText("C:\\Users\\Nazar\\source\\repos\\lab3\\OUTPUT.TXT", new string(grid[i]) + "\n");
            }
        }
        else
        {
            File.WriteAllText("C:\\Users\\Nazar\\source\\repos\\lab3\\OUTPUT.TXT", "N\n");
        }
    }
